(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('d3-scale')) :
  typeof define === 'function' && define.amd ? define(['d3-scale'], factory) :
  (global.ColorControler = factory(global.d3Scale));
}(this, (function (d3Scale) { 'use strict';

  function ColorControler (colormap) 
  {
  // #### Constructor #### 
    var colormaps = {
    ...
    this.toColorlist2D = function(list2D,dataDomain) {
      ...
      for (var i = 0; i < list2D.length; i++) {
        ...
        for (var j = 0; j < list2D[i].length; j++){
          colorList2D[i][j] = colorScale(list2D[i][j]);
        }
      }
